...
public class PollService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String resId = items.get(0).getId();

        if (!resId.equals(lastResultId)) {
            Resources r = getResources();
            PendingIntent pi = PendingIntent.getActivity(
                    this, 0, new Intent(this, PhotoGalleryActivity.class), 0);
        ...
        prefs.edit()
                .putString(FlickrFetchr.PREF_LAST_RESULT_ID, resId)
                .commit();
    }
    ...
    public static void setServiceAlarm(Context context, boolean isOn) {
        ...
        if (isOn) {
            alarmManager.setRepeating(
                    AlarmManager.RTC, System.currentTimeMillis(), POLL_INTERVAL, pi);
        } else {
